...
import org.terasology.entitySystem.orientdb.OrientDBEntityManager;
import org.terasology.entitySystem.orientdb.types.*;
import org.terasology.entitySystem.orientdbobject.OrientDBObjEntityManager;
import org.terasology.entitySystem.orientdbobject.serializers.*;
...
public class StateSinglePlayer implements IGameState {
    ...
    public void init() {
        ...
        entityManager.registerValueSerializer(new Quat4fSerializer());
        entityManager.registerValueSerializer(new SoundSerializer(AudioManager.getInstance()));
        ...
        entityManager.registerComponentType(PlaySoundActionComponent.class);
        entityManager.registerComponentType(TunnelActionComponent.class);
        entityManager.registerComponentType(AABBCollisionComponent.class);
        entityManager.registerComponentType(BlockComponent.class);
        entityManager.registerComponentType(BlockItemComponent.class);
        entityManager.registerComponentType(BlockParticleEffectComponent.class);
        entityManager.registerComponentType(CameraComponent.class);
        entityManager.registerComponentType(CharacterMovementComponent.class);
        entityManager.registerComponentType(CharacterSoundComponent.class);
        entityManager.registerComponentType(HealthComponent.class);
        entityManager.registerComponentType(InventoryComponent.class);
        entityManager.registerComponentType(ItemComponent.class);
        entityManager.registerComponentType(LightComponent.class);
        entityManager.registerComponentType(LocalPlayerComponent.class);
        entityManager.registerComponentType(LocationComponent.class);
        entityManager.registerComponentType(MeshComponent.class);
        entityManager.registerComponentType(PlayerComponent.class);
        entityManager.registerComponentType(SimpleAIComponent.class);
        //entityManager.init();
